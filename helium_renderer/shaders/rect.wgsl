...
struct VertexInput{
	...
	@location(3) rect_position:vec2<f32>,
	@location(4) size:vec2<f32>,
	@location(5) corner_radius:vec2<f32>
}
...
// bounds.x = width
// bounds.y = height
// rounds.x = roundness top-right  
// rounds.y = roundness bottom-right
// rounds.z = roundness top-left
// rounds.w = roundness bottom-left
